...
//                for(int i=indexTokenActual+1;i<this.tokens.size();i++){
//                    if(tokens.get(i).equals(LexemasEnum.L_LLAVE.getLexema())){
//                        contadorL_LLAVE++;
//                    }else if (tokens.get(i).equals(LexemasEnum.L_CORCHETE.getLexema())){
//                        contadorL_CORCHETE++;
//                    }else if(tokens.get(i).equals(LexemasEnum.R_LLAVE.getLexema())){
//                        contadorL_LLAVE--;
//                    }
//                    //Lo primero que encuentre decidirá la producción a utilizar
//                    if(tokens.get(i).equals(LexemasEnum.R_CORCHETE)  ){
//                        if(contadorL_CORCHETE==0 && contadorL_LLAVE==0){
//                            return (List)producciones.get(1);
//                        }else{
//                            contadorL_CORCHETE--;
//                        }
//                    }else if(tokens.get(i).equals(LexemasEnum.COMA) && !this.produccionRepetitivaQuemada){ 
//                        produccionRepetitivaQuemada = true;
//                        return (List)producciones.get(0);
//                    }
//                }
...
//                    }
//                    //Lo primero que encuentre decidirá la producción a utilizar
//                    if(tokens.get(i).equals(LexemasEnum.R_LLAVE)){
