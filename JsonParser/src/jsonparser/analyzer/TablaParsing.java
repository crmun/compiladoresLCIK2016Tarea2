...
public class TablaParsing {
    ...
    public TablaParsing() {
        ...
        array_prima.put(LexemasEnum.R_CORCHETE.getLexema(),      Arrays.asList(POP));
        ...
        element_list.put(LexemasEnum.COMA.getLexema(),            Arrays.asList(POP));
        ...
        attribute_list.put(LexemasEnum.COMA.getLexema(),            Arrays.asList(POP));
